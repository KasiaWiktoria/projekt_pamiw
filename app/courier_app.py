...
from flask_jwt_extended import JWTManager, get_jti, jwt_required, create_access_token, create_refresh_token, set_access_cookies
import redis
import os
import hashlib
...
def active_session():
    log.debug(request.cookies.get(COURIER_SESSION_ID))
