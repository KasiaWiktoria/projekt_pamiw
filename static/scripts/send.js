...
import {validateName, validateSurname, validateCountry, validatePostalCode, validateCity, validateStreet, validateHouseNr, validateLogin, validatePasswd, arePasswdsTheSame, validatePhone} from './validation_functions.js';
...
document.addEventListener('DOMContentLoaded', function (event) {
    ...
    prepareEventOnChange(PRODUCT_NAME_FIELD_ID, validateName, updateCorrectnessMessage);
    ...
    prepareEventOnChange(RECIPENT_NAME_FIELD_ID, validateName, updateCorrectnessMessage);
    prepareEventOnChange(RECIPENT_SURNAME_FIELD_ID, validateSurname, updateCorrectnessMessage);
    prepareEventOnChange(RECIPENT_PHONE_FIELD_ID, validatePhone, updateCorrectnessMessage);
    prepareEventOnChange(RECIPENT_COUNTRY_FIELD_ID, validateCountry, updateCorrectnessMessage);
    prepareEventOnChange(RECIPENT_POSTAL_CODE_FIELD_ID, validatePostalCode ,updateCorrectnessMessage);
    prepareEventOnChange(RECIPENT_CITY_FIELD_ID, validateCity, updateCorrectnessMessage);
    prepareEventOnChange(RECIPENT_STREET_FIELD_ID, validateStreet, updateCorrectnessMessage);
    prepareEventOnChange(RECIPENT_HOUSE_NR_FIELD_ID, validateHouseNr, updateCorrectnessMessage);

    prepareEventOnChange(PACK_IMAGE_FIELD_ID, validateFile, updateCorrectnessMessage);
